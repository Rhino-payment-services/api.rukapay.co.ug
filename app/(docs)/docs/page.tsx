...
import { PARTNER_INSTITUTIONS_PATH } from '@/lib/partner-institutions-api'
...
export default function DocsHomePage() {
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 lg:px-10 xl:max-w-6xl">
      ...
      <section className="mb-12">
        <h2 className="mb-2 text-lg font-semibold text-content">Partner - Institutions</h2>
        <p className="mb-6 max-w-3xl text-sm text-content-muted">
          Onboard SACCOs, manage members and staff, then run savings, shares, and loan
          transactions via <code>{PARTNER_INSTITUTIONS_PATH}</code>.
        </p>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <PaymentModuleCard
            title="Onboarding"
            description="Create and list SACCOs under your partner key."
            href="/partner-institutions/onboarding"
            icon={Building2}
          />
          <PaymentModuleCard
            title="Members"
            description="Register members, validate phone, bulk upload."
            href="/partner-institutions/members"
            icon={Users}
          />
          <PaymentModuleCard
            title="Staff"
            description="Invite staff with roles and permissions."
            href="/partner-institutions/staff"
            icon={UserCog}
          />
          <PaymentModuleCard
            title="Transactions"
            description="Wallet, deposits, loans, shares, and bulk ops."
      ...
      <section>
        ...
        <ul className="space-y-2 text-[15px] text-content-muted">
          ...
          <li>
            <Link href="/partner-institutions" className="text-accent-600 dark:text-accent-400">
              Partner - Institutions
            </Link>{' '}
            — SACCO onboarding, members, staff, transactions
          </li>
          <li>
